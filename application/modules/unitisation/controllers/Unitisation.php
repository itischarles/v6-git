...
/**
 * Description of Unitisation
 * manages the cient's pofolios i.e which portfolio a cient is investing, how many unitis a cient has
 * in the portfolio
 * @author itischarles
 */
class Unitisation extends MY_Controller{
    //put your code here
    private $userDetails;
    ...
    function view($clientUrl) {
        ...
        $data['page_header'] = $clientFullNames;
	...
	$data['extra_js'] = $this->getModule_js();
       ...
       // add breadcrumbs
	$this->breadcrumbs->push('Client Profile', '/client/'.$clientUrl."/view");
	$this->breadcrumbs->push('Edit Profile', '/');

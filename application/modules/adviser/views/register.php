...
<div class="container-fluid bg-gray" style="">
    <div class="row ">
        <div class="col-md-12 bg-white" style="min-height: 200px">
            <div class="content">

                <div class="text-center">
                    <img src="<?php echo base_url('images/im-logo-text.png') ?>" alt="Intelligent Money"/>
                </div>

                <div class="text-center" style="background-color:#696666;color:white;padding:1px;">
                    <img height="128" style="display:inline;" src="<?php echo base_url('images/icons/adviser.png') ?>" alt="Intelligent Money"/>
                    <h2 style="display:inline; margin-left:20px;">Register Financial Adviser</h2>
                </div>
            </div>
        </div>
    </div>			
    ...
    <div class="row row-centered">
        ...
        <div class="col-md-5 col-centered col-md-offset-3" style="min-height: 200px">
            <div class="content">	
...
?>
                ...
                <div class="form-group text-center">	    
                    ...
                    <div class="col-sm-9">
                        <button id="faSelfRegister" name="faSelfRegister" class="btn btn-primary-2" style="width:30%;" value="Add">Register Now...</button>
                    </div>                   
                </div>
...
/*
  ...
  1. DONE.Set display:none; to network and firm divs
  2. empty network and then new firm name will not popup the div showing new fields to add fix this.
  3. Required fields are to be shown with RED asterisk marks.
